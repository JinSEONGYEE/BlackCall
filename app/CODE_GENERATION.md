...
Drift uses code generation to create type-safe database tables and queries.
...
```dart
@DriftDatabase(tables: [CallRecords, SuspiciousPatterns])
class AppDatabase extends _$AppDatabase {
  AppDatabase() : super(_openConnection());
  
  @override
  int get schemaVersion => 2; // Increment when adding tables
...
- `*.g.dart` - Generated by drift_dev
- Contains table definitions and query builders
