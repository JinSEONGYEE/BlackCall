...
class $WhitelistTableTable extends WhitelistTable
  ...
  static const VerificationMeta _phoneNumberHashMeta = const VerificationMeta(
    'phoneNumberHash',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    Insertable<WhitelistTableData> instance, {
  ...
  WhitelistTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WhitelistTableData(
      ...
      phoneNumberHash: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}phone_number_hash'],
      )!,
...
class WhitelistTableData extends DataClass
  ...
  factory WhitelistTableData.fromJson(
  ...
  WhitelistTableData copyWithCompanion(WhitelistTableCompanion data) {
    return WhitelistTableData(
      id: data.id.present ? data.id.value : this.id,
      phoneNumberHash: data.phoneNumberHash.present
          ? data.phoneNumberHash.value
...
class $CallLogTableTable extends CallLogTable
  ...
  static const VerificationMeta _formattedNumberMeta = const VerificationMeta(
    'formattedNumber',
  );
  @override
  ...
  static const VerificationMeta _isKoreanMeta = const VerificationMeta(
    'isKorean',
  );
  @override
  ...
  static const VerificationMeta _isSpoofingRiskMeta = const VerificationMeta(
    'isSpoofingRisk',
  );
  @override
  late final GeneratedColumn<bool> isSpoofingRisk = GeneratedColumn<bool>(
    ...
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("is_spoofing_risk" IN (0, 1))',
    ),
    defaultValue: const Constant(false),
  );
  static const VerificationMeta _isWhitelistedMeta = const VerificationMeta(
    'isWhitelisted',
  );
  @override
  ...
  static const VerificationMeta _callStateMeta = const VerificationMeta(
    'callState',
  );
  @override
  ...
  CallLogTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CallLogTableData(
      ...
      formattedNumber: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}formatted_number'],
      )!,
      isPrivate: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_private'],
      )!,
      isKorean: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_korean'],
      )!,
      isInternational: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_international'],
      )!,
      isSpoofingRisk: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_spoofing_risk'],
      )!,
      isWhitelisted: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_whitelisted'],
      )!,
      callState: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}call_state'],
      )!,
...
class CallLogTableData extends DataClass
  ...
  factory CallLogTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CallLogTableData copyWithCompanion(CallLogTableCompanion data) {
    return CallLogTableData(
      id: data.id.present ? data.id.value : this.id,
      phoneNumber: data.phoneNumber.present
          ? data.phoneNumber.value
          : this.phoneNumber,
      formattedNumber: data.formattedNumber.present
          ? data.formattedNumber.value
          : this.formattedNumber,
      isPrivate: data.isPrivate.present ? data.isPrivate.value : this.isPrivate,
      isKorean: data.isKorean.present ? data.isKorean.value : this.isKorean,
      isInternational: data.isInternational.present
          ? data.isInternational.value
          : this.isInternational,
      isSpoofingRisk: data.isSpoofingRisk.present
          ? data.isSpoofingRisk.value
          : this.isSpoofingRisk,
      isWhitelisted: data.isWhitelisted.present
          ? data.isWhitelisted.value
          : this.isWhitelisted,
      callState: data.callState.present ? data.callState.value : this.callState,
...
class $FraudPatternTableTable extends FraudPatternTable
    with TableInfo<$FraudPatternTableTable, FraudPatternTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _detectedKeywordsMeta = const VerificationMeta(
    'detectedKeywords',
  );
  @override
  late final GeneratedColumn<String> detectedKeywords = GeneratedColumn<String>(
    'detected_keywords',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<FraudPatternTableData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('detected_keywords')) {
      context.handle(
        _detectedKeywordsMeta,
        detectedKeywords.isAcceptableOrUnknown(
  ...
  FraudPatternTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FraudPatternTableData(
      ...
      detectedKeywords: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}detected_keywords'],
      )!,
...
class FraudPatternTableData extends DataClass
    implements Insertable<FraudPatternTableData> {
  final int id;
  ...
  factory FraudPatternTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  FraudPatternTableData copyWith({
    int? id,
    String? patternType,
  ...
  FraudPatternTableData copyWithCompanion(FraudPatternTableCompanion data) {
    return FraudPatternTableData(
      id: data.id.present ? data.id.value : this.id,
      patternType: data.patternType.present
          ? data.patternType.value
          : this.patternType,
      detectedKeywords: data.detectedKeywords.present
          ? data.detectedKeywords.value
...
class FraudPatternTableCompanion
    extends UpdateCompanion<FraudPatternTableData> {
  final Value<int> id;
  ...
  FraudPatternTableCompanion copyWith({
    Value<int>? id,
    Value<String>? patternType,
    Value<String>? detectedKeywords,
...
class $CustomKeywordsTableTable extends CustomKeywordsTable
    with TableInfo<$CustomKeywordsTableTable, CustomKeywordsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CustomKeywordsTableData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class CustomKeywordsTableData extends DataClass
    implements Insertable<CustomKeywordsTableData> {
  final int id;
  ...
  factory CustomKeywordsTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CustomKeywordsTableData copyWith({
    int? id,
    String? keyword,
    DateTime? addedAt,
  }) => CustomKeywordsTableData(
    id: id ?? this.id,
    keyword: keyword ?? this.keyword,
    addedAt: addedAt ?? this.addedAt,
  );
  CustomKeywordsTableData copyWithCompanion(CustomKeywordsTableCompanion data) {
    return CustomKeywordsTableData(
      id: data.id.present ? data.id.value : this.id,
...
class CustomKeywordsTableCompanion
    extends UpdateCompanion<CustomKeywordsTableData> {
  final Value<int> id;
  ...
  CustomKeywordsTableCompanion copyWith({
    Value<int>? id,
...
class $FraudPatternDefinitionTableTable extends FraudPatternDefinitionTable
    with
        TableInfo<
          $FraudPatternDefinitionTableTable,
          FraudPatternDefinitionTableData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<FraudPatternDefinitionTableData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  FraudPatternDefinitionTableData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class FraudPatternDefinitionTableData extends DataClass
    implements Insertable<FraudPatternDefinitionTableData> {
  final int id;
  ...
  const FraudPatternDefinitionTableData({
    required this.id,
    required this.patternType,
  ...
  factory FraudPatternDefinitionTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  FraudPatternDefinitionTableData copyWith({
    int? id,
    String? patternType,
    String? keywords,
    DateTime? updatedAt,
  ...
  FraudPatternDefinitionTableData copyWithCompanion(
    FraudPatternDefinitionTableCompanion data,
  ) {
    return FraudPatternDefinitionTableData(
      id: data.id.present ? data.id.value : this.id,
      patternType: data.patternType.present
...
class FraudPatternDefinitionTableCompanion
    extends UpdateCompanion<FraudPatternDefinitionTableData> {
  final Value<int> id;
  final Value<String> patternType;
  ...
  FraudPatternDefinitionTableCompanion copyWith({
    Value<int>? id,
    Value<String>? patternType,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $FraudPatternTableTable fraudPatternTable =
      $FraudPatternTableTable(this);
  late final $CustomKeywordsTableTable customKeywordsTable =
      $CustomKeywordsTableTable(this);
  late final $FraudPatternDefinitionTableTable fraudPatternDefinitionTable =
      $FraudPatternDefinitionTableTable(this);
  @override
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities => [
    ...
    fraudPatternTable,
    customKeywordsTable,
    fraudPatternDefinitionTable,
  ];
}

typedef $$WhitelistTableTableCreateCompanionBuilder =
    WhitelistTableCompanion Function({
      Value<int> id,
      required String phoneNumberHash,
      Value<String?> contactName,
      required DateTime addedAt,
    });
typedef $$WhitelistTableTableUpdateCompanionBuilder =
    WhitelistTableCompanion Function({
      Value<int> id,
      Value<String> phoneNumberHash,
      Value<String?> contactName,
...
class $$WhitelistTableTableFilterComposer
    extends Composer<_$AppDatabase, $WhitelistTableTable> {
  $$WhitelistTableTableFilterComposer({
    required super.$db,
  ...
  ColumnFilters<String> get phoneNumberHash => $composableBuilder(
    column: $table.phoneNumberHash,
    builder: (column) => ColumnFilters(column),
  );
...
class $$WhitelistTableTableOrderingComposer
    extends Composer<_$AppDatabase, $WhitelistTableTable> {
  $$WhitelistTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get phoneNumberHash => $composableBuilder(
    column: $table.phoneNumberHash,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$WhitelistTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $WhitelistTableTable> {
  $$WhitelistTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get phoneNumberHash => $composableBuilder(
    column: $table.phoneNumberHash,
...
class $$WhitelistTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $WhitelistTableTable,
          ...
          $$WhitelistTableTableOrderingComposer,
          $$WhitelistTableTableAnnotationComposer,
          $$WhitelistTableTableCreateCompanionBuilder,
          $$WhitelistTableTableUpdateCompanionBuilder,
          (
            WhitelistTableData,
            BaseReferences<
              _$AppDatabase,
        ...
        > {
  $$WhitelistTableTableTableManager(
    _$AppDatabase db,
    $WhitelistTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WhitelistTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WhitelistTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$WhitelistTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> phoneNumberHash = const Value.absent(),
                Value<String?> contactName = const Value.absent(),
                Value<DateTime> addedAt = const Value.absent(),
              }) => WhitelistTableCompanion(
                id: id,
...
typedef $$WhitelistTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        WhitelistTableData,
        BaseReferences<_$AppDatabase, $WhitelistTableTable, WhitelistTableData>,
      ),
      WhitelistTableData,
      PrefetchHooks Function()
    >;
typedef $$CallLogTableTableCreateCompanionBuilder =
    CallLogTableCompanion Function({
      Value<int> id,
      required String phoneNumber,
      required String formattedNumber,
      required bool isPrivate,
...
typedef $$CallLogTableTableUpdateCompanionBuilder =
    CallLogTableCompanion Function({
      Value<int> id,
      Value<String> phoneNumber,
      Value<String> formattedNumber,
...
class $$CallLogTableTableFilterComposer
    extends Composer<_$AppDatabase, $CallLogTableTable> {
  $$CallLogTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get formattedNumber => $composableBuilder(
    column: $table.formattedNumber,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<bool> get isKorean => $composableBuilder(
    column: $table.isKorean,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<bool> get isSpoofingRisk => $composableBuilder(
    column: $table.isSpoofingRisk,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<bool> get isWhitelisted => $composableBuilder(
    column: $table.isWhitelisted,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get callState => $composableBuilder(
    column: $table.callState,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CallLogTableTableOrderingComposer
    extends Composer<_$AppDatabase, $CallLogTableTable> {
  $$CallLogTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get formattedNumber => $composableBuilder(
    column: $table.formattedNumber,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<bool> get isKorean => $composableBuilder(
    column: $table.isKorean,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<bool> get isSpoofingRisk => $composableBuilder(
    column: $table.isSpoofingRisk,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<bool> get isWhitelisted => $composableBuilder(
    column: $table.isWhitelisted,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get callState => $composableBuilder(
    column: $table.callState,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CallLogTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $CallLogTableTable> {
  $$CallLogTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get formattedNumber => $composableBuilder(
    column: $table.formattedNumber,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<bool> get isKorean =>
      $composableBuilder(column: $table.isKorean, builder: (column) => column);
  ...
  GeneratedColumn<bool> get isSpoofingRisk => $composableBuilder(
    column: $table.isSpoofingRisk,
    builder: (column) => column,
  );

  GeneratedColumn<bool> get isWhitelisted => $composableBuilder(
    column: $table.isWhitelisted,
    builder: (column) => column,
  );

  GeneratedColumn<String> get callState =>
      $composableBuilder(column: $table.callState, builder: (column) => column);
...
class $$CallLogTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CallLogTableTable,
          ...
          $$CallLogTableTableOrderingComposer,
          $$CallLogTableTableAnnotationComposer,
          $$CallLogTableTableCreateCompanionBuilder,
          $$CallLogTableTableUpdateCompanionBuilder,
          (
            CallLogTableData,
            BaseReferences<_$AppDatabase, $CallLogTableTable, CallLogTableData>,
          ),
          CallLogTableData,
          PrefetchHooks Function()
        > {
  $$CallLogTableTableTableManager(_$AppDatabase db, $CallLogTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CallLogTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CallLogTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CallLogTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> phoneNumber = const Value.absent(),
                Value<String> formattedNumber = const Value.absent(),
                Value<bool> isPrivate = const Value.absent(),
                Value<bool> isKorean = const Value.absent(),
                Value<bool> isInternational = const Value.absent(),
                Value<bool> isSpoofingRisk = const Value.absent(),
                Value<bool> isWhitelisted = const Value.absent(),
                Value<String> callState = const Value.absent(),
...
typedef $$CallLogTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CallLogTableTable,
      CallLogTableData,
      ...
      PrefetchHooks Function()
    >;
typedef $$FraudPatternTableTableCreateCompanionBuilder =
    FraudPatternTableCompanion Function({
      Value<int> id,
      required String patternType,
      required String detectedKeywords,
      required double confidence,
...
typedef $$FraudPatternTableTableUpdateCompanionBuilder =
    FraudPatternTableCompanion Function({
      Value<int> id,
      Value<String> patternType,
      Value<String> detectedKeywords,
...
class $$FraudPatternTableTableFilterComposer
    extends Composer<_$AppDatabase, $FraudPatternTableTable> {
  $$FraudPatternTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get detectedKeywords => $composableBuilder(
    column: $table.detectedKeywords,
    builder: (column) => ColumnFilters(column),
  );
...
class $$FraudPatternTableTableOrderingComposer
    extends Composer<_$AppDatabase, $FraudPatternTableTable> {
  $$FraudPatternTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get detectedKeywords => $composableBuilder(
    column: $table.detectedKeywords,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$FraudPatternTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $FraudPatternTableTable> {
  $$FraudPatternTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get detectedKeywords => $composableBuilder(
    column: $table.detectedKeywords,
    builder: (column) => column,
  );
...
class $$FraudPatternTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $FraudPatternTableTable,
          FraudPatternTableData,
          $$FraudPatternTableTableFilterComposer,
          $$FraudPatternTableTableOrderingComposer,
          $$FraudPatternTableTableAnnotationComposer,
          $$FraudPatternTableTableCreateCompanionBuilder,
          $$FraudPatternTableTableUpdateCompanionBuilder,
          (
            FraudPatternTableData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$FraudPatternTableTableTableManager(
    _$AppDatabase db,
    $FraudPatternTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$FraudPatternTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$FraudPatternTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$FraudPatternTableTableAnnotationComposer(
                $db: db,
                $table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> detectedKeywords = const Value.absent(),
                Value<double> confidence = const Value.absent(),
                Value<DateTime> timestamp = const Value.absent(),
                Value<int?> callLogId = const Value.absent(),
              }) => FraudPatternTableCompanion(
                id: id,
...
typedef $$FraudPatternTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $FraudPatternTableTable,
      FraudPatternTableData,
      ...
      PrefetchHooks Function()
    >;
typedef $$CustomKeywordsTableTableCreateCompanionBuilder =
    CustomKeywordsTableCompanion Function({
      Value<int> id,
      required String keyword,
      Value<DateTime> addedAt,
    });
typedef $$CustomKeywordsTableTableUpdateCompanionBuilder =
    CustomKeywordsTableCompanion Function({
      Value<int> id,
      Value<String> keyword,
      Value<DateTime> addedAt,
...
class $$CustomKeywordsTableTableFilterComposer
    extends Composer<_$AppDatabase, $CustomKeywordsTableTable> {
  $$CustomKeywordsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomKeywordsTableTableOrderingComposer
    extends Composer<_$AppDatabase, $CustomKeywordsTableTable> {
  $$CustomKeywordsTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomKeywordsTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $CustomKeywordsTableTable> {
  $$CustomKeywordsTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomKeywordsTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CustomKeywordsTableTable,
          CustomKeywordsTableData,
          $$CustomKeywordsTableTableFilterComposer,
          $$CustomKeywordsTableTableOrderingComposer,
          $$CustomKeywordsTableTableAnnotationComposer,
          $$CustomKeywordsTableTableCreateCompanionBuilder,
          $$CustomKeywordsTableTableUpdateCompanionBuilder,
          (
            CustomKeywordsTableData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$CustomKeywordsTableTableTableManager(
    _$AppDatabase db,
    $CustomKeywordsTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CustomKeywordsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CustomKeywordsTableTableOrderingComposer(
                $db: db,
                $table: table,
...
typedef $$CustomKeywordsTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CustomKeywordsTableTable,
      CustomKeywordsTableData,
      ...
      PrefetchHooks Function()
    >;
typedef $$FraudPatternDefinitionTableTableCreateCompanionBuilder =
    FraudPatternDefinitionTableCompanion Function({
      Value<int> id,
      required String patternType,
      required String keywords,
      Value<DateTime> updatedAt,
    });
typedef $$FraudPatternDefinitionTableTableUpdateCompanionBuilder =
    FraudPatternDefinitionTableCompanion Function({
      Value<int> id,
      Value<String> patternType,
      Value<String> keywords,
...
class $$FraudPatternDefinitionTableTableFilterComposer
    extends Composer<_$AppDatabase, $FraudPatternDefinitionTableTable> {
  $$FraudPatternDefinitionTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$FraudPatternDefinitionTableTableOrderingComposer
    extends Composer<_$AppDatabase, $FraudPatternDefinitionTableTable> {
  $$FraudPatternDefinitionTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$FraudPatternDefinitionTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $FraudPatternDefinitionTableTable> {
  $$FraudPatternDefinitionTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$FraudPatternDefinitionTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $FraudPatternDefinitionTableTable,
          ...
          $$FraudPatternDefinitionTableTableOrderingComposer,
          $$FraudPatternDefinitionTableTableAnnotationComposer,
          $$FraudPatternDefinitionTableTableCreateCompanionBuilder,
          $$FraudPatternDefinitionTableTableUpdateCompanionBuilder,
          (
            FraudPatternDefinitionTableData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$FraudPatternDefinitionTableTableTableManager(
    _$AppDatabase db,
    $FraudPatternDefinitionTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ...
              }) => FraudPatternDefinitionTableCompanion(
                id: id,
                patternType: patternType,
                keywords: keywords,
                updatedAt: updatedAt,
...
typedef $$FraudPatternDefinitionTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $FraudPatternDefinitionTableTable,
      FraudPatternDefinitionTableData,
...
class $AppDatabaseManager {
  ...
  $$WhitelistTableTableTableManager get whitelistTable =>
      $$WhitelistTableTableTableManager(_db, _db.whitelistTable);
  $$CallLogTableTableTableManager get callLogTable =>
      $$CallLogTableTableTableManager(_db, _db.callLogTable);
  $$FraudPatternTableTableTableManager get fraudPatternTable =>
      $$FraudPatternTableTableTableManager(_db, _db.fraudPatternTable);
  $$CustomKeywordsTableTableTableManager get customKeywordsTable =>
      $$CustomKeywordsTableTableTableManager(_db, _db.customKeywordsTable);
  $$FraudPatternDefinitionTableTableTableManager
  get fraudPatternDefinitionTable =>
      $$FraudPatternDefinitionTableTableTableManager(
        _db,
