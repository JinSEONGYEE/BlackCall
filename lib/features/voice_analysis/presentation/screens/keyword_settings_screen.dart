...
class _KeywordSettingsScreenState
  ...
  void _save(List<dynamic> existing) {
    final notifier = ref.read(customKeywordsNotifierProvider.notifier);
  ...
  Widget build(BuildContext context) {
    final keywordsAsync = ref.watch(customKeywordsNotifierProvider);
    ...
    return Scaffold(
      ...
      body: keywordsAsync.when(
        data: (existing) => _Body(
          ...
          onRemoveExisting: (id) =>
              ref.read(customKeywordsNotifierProvider.notifier).removeKeyword(id),
        ),
        loading: () =>
