...
// ── Phishing Graphic: phone icon + warning bubble ─────────────────────────────
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.only(
          ...
          // No bottom-left radius → speech bubble pointing left-down
        ),
      ),
      child: const Text(
        '보이스피싱이 의심됩니다',
